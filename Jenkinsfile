pipeline {
    ...
    stages {
        stage('Checkout Code') {
            steps {
                git 'https://github.com/Ravinder919/sample-sonarqube.git' // Use your Git repository URL
            }
        }
        ...
        stage('SonarQube Analysis') {
            environment {
                SONAR_HOST_URL = 'http://54.67.78.125:9000/' // Replace with your SonarQube URL
